...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		Texture2D::sptr character1 = Texture2D::LoadFromFile("images/SkinPNG.png");
		Texture2D::sptr character2 = Texture2D::LoadFromFile("images/Duncet.png");
		Texture2D::sptr Monkeybar = Texture2D::LoadFromFile("images/MonkeyBar.png");
		Texture2D::sptr RA = Texture2D::LoadFromFile("images/Roundabout.png");
		Texture2D::sptr bottle = Texture2D::LoadFromFile("images/Bottle.png");
		...
		ShaderMaterial::sptr character1Mat = ShaderMaterial::Create();
		character1Mat->Shader = shader;
		character1Mat->Set("s_Diffuse", character1);
		character1Mat->Set("s_Specular", noSpec);
		character1Mat->Set("u_Shininess", 8.0f);
		character1Mat->Set("u_TextureMix", 0.0f);
		
		ShaderMaterial::sptr character2Mat = ShaderMaterial::Create();
		character2Mat->Shader = shader;
		character2Mat->Set("s_Diffuse", character2);
		character2Mat->Set("s_Specular", noSpec);
		character2Mat->Set("u_Shininess", 8.0f);
		character2Mat->Set("u_TextureMix", 0.0f);
		
		ShaderMaterial::sptr MonkeyBarMat = ShaderMaterial::Create();
		MonkeyBarMat->Shader = shader;
		MonkeyBarMat->Set("s_Diffuse", Monkeybar);
		MonkeyBarMat->Set("s_Specular", noSpec);
		MonkeyBarMat->Set("u_Shininess", 8.0f);
		MonkeyBarMat->Set("u_TextureMix", 0.0f);
		
		ShaderMaterial::sptr RAMat = ShaderMaterial::Create();
		RAMat->Shader = shader;
		RAMat->Set("s_Diffuse", RA);
		RAMat->Set("s_Specular", noSpec);
		RAMat->Set("u_Shininess", 8.0f);
		RAMat->Set("u_TextureMix", 0.0f);
		
		ShaderMaterial::sptr BottleMat = ShaderMaterial::Create();
		BottleMat->Shader = shader;
		BottleMat->Set("s_Diffuse", bottle);
		BottleMat->Set("s_Specular", noSpec);
		BottleMat->Set("u_Shininess", 8.0f);
		...
		GameObject obj2 = scene->CreateEntity("character1");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Dunce.obj");
			obj2.emplace<RendererComponent>().SetMesh(vao).SetMaterial(character1Mat);
		...
		GameObject obj3 = scene->CreateEntity("character2");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Duncet.obj");
			obj3.emplace<RendererComponent>().SetMesh(vao).SetMaterial(character2Mat);
			obj3.get<Transform>().SetLocalPosition(0.0f, -1.5f, 0.0f);
		...
		GameObject obj4 = scene->CreateEntity("Monkeybar");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/MonkeyBar.obj");
			obj4.emplace<RendererComponent>().SetMesh(vao).SetMaterial(MonkeyBarMat);
			obj4.get<Transform>().SetLocalPosition(2.0f, 0.0f, 1.5f);
			obj4.get<Transform>().SetLocalRotation(90.0f, 0.0f, 0.0f);
			obj4.get<Transform>().SetLocalScale(0.25f, 0.25f, 0.25f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj4);
		}
		
		GameObject obj5 = scene->CreateEntity("RA");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/RoundAbout.obj");
			obj5.emplace<RendererComponent>().SetMesh(vao).SetMaterial(RAMat);
			obj5.get<Transform>().SetLocalPosition(-2.0f, 0.0f, 0.5f);
			obj5.get<Transform>().SetLocalRotation(90.0f, 0.0f, 0.0f);
			obj5.get<Transform>().SetLocalScale(0.25f, 0.25f, 0.25f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj5);
		}
		
		GameObject obj6 = scene->CreateEntity("bottle");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/waterBottle.obj");
			obj6.emplace<RendererComponent>().SetMesh(vao).SetMaterial(BottleMat);
			obj6.get<Transform>().SetLocalPosition(0.0f, 0.0f, 0.25f);
			obj6.get<Transform>().SetLocalRotation(90.0f, 0.0f, 0.0f);
			obj6.get<Transform>().SetLocalScale(0.25f, 0.25f, 0.25f);
		...
		GameObject depthoffieldEffectObject = scene->CreateEntity("Greyscale Effect");
		{
			depthoffieldEffect = &depthoffieldEffectObject.emplace<depthoffield>();
